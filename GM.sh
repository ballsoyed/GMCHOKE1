...
#download script cd /usr/bin wget -O 0 "https://raw.githubusercontent.com/gmchoke/GMCHOKE1/master/menu1.sh" wget -O 1 "https://raw.githubusercontent.com/gmchoke/GMCHOKE1/master/1.sh
